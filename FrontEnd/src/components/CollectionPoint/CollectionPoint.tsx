    ...
    <div className="c-CP">
      ...
      <div className="c-CP__info">
        ...
        <div className="c-CP__info__mapInfo">
          ...
          <p className="c-CP__info__mapInfo__lon__title c-CP__title">Latitude:</p> 
            <p className="c-CP__info__mapInfo__lat__text">{latitude}</p>
          </div>
          <div className="c-CP__indo__mapInfo__lon">
            <p className="c-CP__info__mapInfo__lon__title c-CP__title">Longitude:</p>
        ...
        <div className="c-CP__info__administrator">
          <p className="c-CP__info__administrator__title c-CP__title">Administradora</p> 
          <div className="c-CP__info__administrator__info">
            <img className="c-CP__info__administrator__info__image" src="./CollectionPoints/Embu_Brasao.png"/>
            <div className="c-CP__info__administrator__info__main">
              <p className="c-CP__info__administrator__info__main__name">{administradora.nome}</p>
              <p className="c-CP__info__administrator__info__main__local">{administradora.cidade} - {administradora.estado}</p>
            </div>
          </div>
        </div>
        <div className="c-CP__info__materials">
          ...
          <div className="c-CP__info__materials__wrapper">
            {materiais.map((material) => {
              ...
              return (
                <div className="c-CP__info__materials__single" key={material.id} style={{backgroundColor: divColor}}>
                  <p className="c-CP__info__materials__text">
                    {material.nome}
                  </p>
                </div>
              );
      ...
      <div className="c-CP__disponibility">
        ...
        <div className="c-CP__disponibility__adressInfo">
          <p className="c-CP__disponibility__adressInfo__mainInfo">{logradouro}, {numero}</p>
          <p className="c-CP__disponibility__adressInfo__secondInfo">{bairro}, {estado}</p>
          <p className="c-CP-disponibility__adresInfo__otherInfo">{cep} - {pais}</p>
        </div>
        <div className="c-CP__disponibililty__Wrapper">
          <div className="c-CP__disponibility__wrapper2__funcionality">
            <p className="c-CP_disponibility__wrapper2__funcionality__title c-CP__title">Funcionalidade:</p>
          ...
          <div className="c-CP__disponibility__wrapper__hour">
            <div className="c-CP__disponibility__wrapper3__opening">
              <p className="c-CP__disponibility__wrapper3__opening__title c-CP__title">Abertura:</p>  
              <p className="c-CP__disponibility__wrapper3__opening__info">{horario_inicio}</p>
            </div>
            <div className="c-CP__disponibility__wrapper3__closing">
              <p className="c-CP__disponibility__wrapper3__closing__title c-CP__title">Fechamento:</p> 
              <p className="c-CP__disponibility__wrapper3__closing__info">{horario_termino}</p>
            </div>
          </div>
